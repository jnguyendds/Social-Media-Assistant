(function(root){
  ...
  function render(result,state={}){
    ...
    <div class="card option-detail"><div class="row" style="align-items:flex-start;gap:12px"><div><div class="sect-t">Selected option</div><h2>${esc(option.name)}</h2></div><span class="score-pill">${scoreLabel(option)}</span></div>${scoreBreakdown(option)}${reportPanel(option)}
